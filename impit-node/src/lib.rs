...
use impit::{impit::{Impit, ImpitBuilder, ErrorType}, request::RequestOptions};
...
impl ImpitWrapper {
    ...
    #[napi]
    pub async unsafe fn fetch(&mut self, url: String, request_init: Option<RequestInit>) -> Result<ImpitResponse, napi::Error> {
