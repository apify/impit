  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        if (bindingPackageVersion !== '0.9.2' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 0.9.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
    ...
    if (process.arch === 'x64') {
      if (process.config?.variables?.shlib_suffix === 'dll.a' || process.config?.variables?.node_target_type === 'shared_library') {
        try {
        return require('./impit-node.win32-x64-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        const binding = require('impit-win32-x64-gnu')
        const bindingPackageVersion = require('impit-win32-x64-gnu/package.json').version
        if (bindingPackageVersion !== '0.9.2' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 0.9.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
        ...
        try {
        return require('./impit-node.win32-x64-msvc.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'x64') {
      try {
        return require('./impit-node.freebsd-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'x64') {
      ...
      try {
        return require('./impit-node.linux-ppc64-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
...
module.exports.Browser = nativeBinding.Browser
module.exports.HttpMethod = nativeBinding.HttpMethod
module.exports.OperatingSystem = nativeBinding.OperatingSystem
